                                                            ...
                                                            <td align="right" valign="middle" class="flexibleContainerBox">
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:100%;">
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                                Nếu bạn gặp vấn đề ,hãy xem email <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank" style="text-decoration:none;border-bottom:1px solid #828282;color:#828282;"><span style="color:#828282;">trên trình duyệt !!!</span></a>.
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent">
                                                                <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">NHÀ XE THU ĐỨC</h1>
                                                                <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">THÔNG TIN VÉ XE ĐÃ ĐẶT</h2>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td valign="top" class="imageContent">
                                                                <img src="{{asset('images/email.jpg')}}" width="500" class="flexibleImage" style="max-width:500px;width:100%;display:block;" alt="Text" title="Text" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top">
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:20px;">
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Có vẻ bạn đã đặt vé xe bên chúng tôi , đây là thông tin chuyến xe : </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            ...
                                                                            <div data-v-60883350="" id="ticket-infomation-container" class="buy-info-container">
                                                                                <div data-v-60883350="" class="title-bar-bg"><p data-v-60883350="" class="title-txt" style="font-weight: bold">THÔNG TIN MUA
                                                                                        VÉ</p></div>
                                                                                        ...
                                                                                        <div data-v-2d0d5948="" class="row">
                                                                                            <div data-v-2d0d5948="" class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-ms-12 font-size-18">
                                                                                                <div data-v-2d0d5948="" class="col-xs-12 field">
                                                                                                    <div data-v-2d0d5948="" class="col-xs-4 sub-tit" style="font-weight: bold">Họ tên:</div>
                                                                                                    <div data-v-2d0d5948="" class="col-xs-8 text-right">{{$info->arr_customer['name']}}</div>
                                                                                                </div>
                                                                                                <div data-v-2d0d5948="" class="col-xs-12 field">
                                                                                ...
                                                                                <div data-v-e65218d2="" data-v-60883350="">
                                                                                    <div data-v-e65218d2="" class="ticket-info-container">
                                                                                        <div data-v-e65218d2="" class="title-bar">
                                                                                            <div data-v-e65218d2="" class="title-txt" ><p data-v-e65218d2="" style="font-weight: bold !important;">Thông tin chuyến: {{$info->arr_bus['route_name']}}</p></div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div data-v-e65218d2="" class="row">
                                                                                                <div data-v-e65218d2="" class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-ms-12">
                                                                                                    <div data-v-e65218d2="" class="col-xs-12 field">
                                                                                                        <div data-v-e65218d2="" class="col-xs-4 sub-tit" style="font-weight: bold">Tuyến xe:</div>
                                                                                                        <div data-v-e65218d2="" class="col-xs-8"><span data-v-e65218d2="">{{$info->arr_bus['route_name']}}</span>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div data-v-e65218d2="" class="col-xs-12 field">
                                                                                                        <div data-v-e65218d2="" class="col-xs-4 sub-tit" style="font-weight: bold">Thời gian:</div>
                                                                                                        <div data-v-e65218d2="" class="col-xs-8">
                                                                                                            <span data-v-e65218d2="" class="orange-value green" style="margin-left:5px;color:green;">{{$info->arr_bus['departure_time']}}</span>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div data-v-e65218d2="" class="col-xs-12 field">
                                                                                                        <div data-v-e65218d2="" class="col-xs-4 sub-tit" style="font-weight: bold">Điểm lên xe:</div>
                                                                                                        <div data-v-e65218d2="" class="col-xs-8" style="margin-left:1px;">{{$info->location_name}}
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div data-v-e65218d2="" class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-ms-12">
                                                                                                    <div data-v-e65218d2="" class="col-xs-12 field">
                                                                                                        <div data-v-e65218d2="" class="col-xs-4 sub-tit" style="font-weight: bold">Số lượng ghế:</div>
                                                                                                        <div data-v-e65218d2="" class="col-xs-8 orange-value green">
                                                                                                            <span data-v-e65218d2=""style="margin-left:30px;color:green;"> {{$info->arr_bus['quantity']}} </span>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div data-v-e65218d2="" class="col-xs-12 field">
                                                                                                        <div data-v-e65218d2="" class="col-xs-4 sub-tit" style="font-weight: bold">Tên tài xế:</div>
                                                                                                        <div data-v-e65218d2="" class="col-xs-8">
                                                                                                            <span data-v-e65218d2="" style="margin-left: 5px"> {{$info->driver['name']}} </span>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div data-v-e65218d2="" class="col-xs-12 field">
                                                                                                        <div data-v-e65218d2="" class="col-xs-4 sub-tit" style="font-weight: bold">Số tài xế:</div>
                                                                                                        <div data-v-e65218d2="" class="col-xs-8">
                                                                                                            <span data-v-e65218d2=""> {{$info->driver['phone']}} </span>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div data-v-e65218d2="" class="col-xs-12 field">
                                                                                                        <div data-v-e65218d2="" class="col-xs-4 sub-tit" style="font-weight: bold">P.T Thanh Toán:</div>
                                                                                                        <div data-v-e65218d2="" class="col-xs-8">
                                                                                                            <span data-v-e65218d2=""> {{$info->payment_method}} </span>
                                                                                                        </div>
                                                                                                    </div>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:20px;">
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:17px;font-weight:bold;margin-bottom:0;color:#5F5F5F;line-height:135%;"
                                                                            >Chúng tôi xin gửi lời cảm ơn chân thành đến Quý khách hàng đã đặt hàng. Chúc bạn luôn có nhiều sức khỏe, may mắn và thành công!</div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
                                                                    <tr>
                                                                        <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                                                            <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="{{route('index')}}" target="_blank">Tham quan web chúng tôi</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>

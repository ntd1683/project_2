    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.buses.update', $buses)}}" id="form" method="post">
                        @csrf
                        ...
                        <div class="mt-4 text-center">
                            <button class="btn btn-primary" type="submit">Sửa Chuyến Xe</button>
    ...
    @push('js')
        ...
        <script>
            $(document).ready(function() {
                ...
                let license_plate = '{{$carriage->license_plate}}';
                let driver_name = '{{$driver->name}}';
                let price = {{$buses->price}};
                let date = moment('{{$buses->departure_time}}').format('YYYY-MM-DD');
                let time = moment('{{$buses->departure_time}}').format('HH:mm');
